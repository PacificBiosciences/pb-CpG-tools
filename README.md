...
As an example, the v2.3.1 release can be obtained as follows:
...
- Hard-clipping cannot be used for supplementary alignments. Doing so will create invalid methylation records.
Methylated reads mapped with [pbmm2](https://github.com/PacificBiosciences/pbmm2) or with minimap2 using the `-Y` flag
